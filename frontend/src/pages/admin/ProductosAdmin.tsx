  ...
  return (
    <div className="animate-fade-in">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          <h1 className="text-4xl font-black text-gray-900 tracking-tight">Gestión de Productos</h1>
          <p className="text-sm font-bold text-gray-400 mt-2 uppercase tracking-widest">Administra tu inventario y precios</p>
        </div>
      ...
      {loading ? (
        <LoadingSpinner message="Preparando inventario..." />
      ) : (
